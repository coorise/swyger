const HTTP_RESPONSE_CODE={
  ...
  MESSAGE:{
    ...
    _400:'Error from user, please check your database api variables',
    _401:'The user is not logged in, please login first',
    _402:'There is no Access-Key or Not Valid in Header!',
    _403:'The user is not authorized to do this request!',
    _404:'Sorry, but this page is not available!',
    _500:'Sorry, there is an internal error from database server due to your request, contact the supplier!'
  }
}
