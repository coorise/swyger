...
import ${SingularName}Validation from '../../validations/typeorm/${PluralName}.validation'
...
${SingularName}Route.setHandler.create.many.handlers=[${SingularName}Validation.createMany]
