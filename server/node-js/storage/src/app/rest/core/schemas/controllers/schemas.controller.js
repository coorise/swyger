...
import schemaService from '../services/typeorm/schemas.service';
import {execSync} from "child_process";


class SchemaController extends TypeController {
  name
...
export default new SchemaController(schemaService, 'schemas');
