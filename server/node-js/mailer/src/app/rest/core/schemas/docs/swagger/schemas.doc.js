...
//--------------Begin Send One------------------//
schemaSwagger.setData.send.one.isActive=false
/*schemaSwagger.setData.send.one.data={
    parameter:{
...
//--------------Begin Send Many------------------//
schemaSwagger.setData.send.many.isActive=false
/*schemaSwagger.setData.send.many.data={
    parameter:{
