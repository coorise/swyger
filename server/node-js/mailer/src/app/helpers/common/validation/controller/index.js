...
class ValidationController{
  ...
  sendOne =async (req, res, next)=> await sendOne(this.validation,this._name,req, res, next)
  sendMany =async (req, res, next)=> await sendMany(this.validation,this._name,req, res, next)
