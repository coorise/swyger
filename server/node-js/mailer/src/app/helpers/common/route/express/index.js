...
export default class ModelRoute{
    ...
    setSendMany(data=this.setHandler.send.many){
        ...
        let defaultValue={
            ...
            isActive:true,
            handlers:[],
            controller:this.modelController.sendMany
        }
        if(data.defaultAuth){
            data.handlers=[...this.requireAuth,...data.handlers]
        }
    ...
    setSendOne(data=this.setHandler.send.one){
        let defaultValue={
            method:'post',
            ...
            isActive:true,
            handlers:[],
            controller:this.modelController.sendOne
        }
        if(data.defaultAuth){
            data.handlers=[...this.requireAuth,...data.handlers]
        }
    ...
    getDefaultCRUD(){
        ...
        if(this.setHandler.send.many.isActive){
            this.setSendMany()
        }

        if(this.setHandler.send.one.isActive){
