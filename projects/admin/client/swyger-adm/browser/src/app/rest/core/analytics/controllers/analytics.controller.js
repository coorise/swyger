...
export default class AnalyticController extends BaseController{

    constructor() {
      super();
      //this.theme='default'
      this.parentPath='/app/api/analytics/'
      this.pathTheme='/index.html'
      this.parentComponentPath='analytics.view.html'
    }
    index=async (req)=>{
       let meta={
         title:"Analytics | Agglomy !",
         meta: [
           {
             name: "child value",
